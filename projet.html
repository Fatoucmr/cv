...
Pour cette version, j'ai copier-coller mon projet et j'ai demandé à l'IA (gemini) de me le faire. J’ai formulé un prompt décrivant le jeu que je voulais créer : des étoiles apparaissant à l’écran, se déplaçant grâce à des animations, et que le joueur doit cliquer pour les attraper et gagner des points. L’IA m’a fourni une première version fonctionnelle du code, que j’ai ensuite relue. J’ai ensuite modifié moi-même la couleur des étoiles et de l'encadré du score en m’aidant du site web "palettedecouleur", afin de choisir celle qui me correspondait le mieux.
